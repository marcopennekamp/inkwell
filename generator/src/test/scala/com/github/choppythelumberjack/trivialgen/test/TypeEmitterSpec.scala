...
import com.github.choppythelumberjack.trivialgen.generator.{Import, ImportSimplifyingTypeEmitter}
import com.github.choppythelumberjack.trivialgen.test.TypeEmitterSpec.traits.Trait
import com.github.choppythelumberjack.trivialgen.test.TypeEmitterSpec.{CaseClass, ParamAlias, SimpleAlias}
...
class TypeEmitterSpec extends FlatSpec with Matchers {
  ...
  private def basicEmitter() = new ImportSimplifyingTypeEmitter(Set(
    Import.Package("com.github.choppythelumberjack.trivialgen.test.TypeEmitterSpec"),
  ))
